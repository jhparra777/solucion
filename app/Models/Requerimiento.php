...
class Requerimiento extends Model
{
    ...
    protected $fillable = [
        ...
        'cluster',
        'sercon_id',
        'dias_semana_teletrabajo_id',
        'horario_teletrabajo_id',
        'tipo_teletrabajador_id',
        'descanso_teletrabajador_id',
        'dias_teletrabajo_id',
        'dias_trabajo_oficina_id',
        'visita_domiciliaria',
        'tipo_visita_id',
    ...
    public function sercon(){
        return $this->belongsTo('App\Models\Sercon',"sercon_id","id");
    }

    public function dias_semana_teletrabajo(){
        return $this->belongsTo('App\Models\DiasSemanaTeletrabajo',"dias_semana_teletrabajo_id","id");
    }

    public function horario_teletrabajo(){
        return $this->belongsTo('App\Models\HorarioTeletrabajo',"horario_teletrabajo_id","id");
    }

    public function tipo_teletrabajador(){
        return $this->belongsTo('App\Models\TipoTeletrabajador',"tipo_teletrabajador_id","id");
    }

    public function descanso_teletrabajador(){
        return $this->belongsTo('App\Models\DescansoTeletrabajador',"descanso_teletrabajador_id","id");
    }

    public function dias_teletrabajo(){
        return $this->belongsTo('App\Models\DiasTeletrabajo',"dias_teletrabajo_id","id");
    }

    public function dias_trabajo_oficina(){
        return $this->belongsTo('App\Models\DiasTrabajoOficina',"dias_trabajo_oficina_id","id");
    }
    ...
    {
        $tipo_trabajo = TipoTrabajo::select("*")
        ->where("id", $this->tipo_trabajo_id)
        //->where("active", 1)
        ->first();
