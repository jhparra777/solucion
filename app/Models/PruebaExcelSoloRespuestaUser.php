...
class PruebaExcelSoloRespuestaUser extends Model
{
    protected $table    = 'prueba_excel_solo_respuestas_user';
    protected $fillable = [
        'user_id',
        'tipo',
    ...
    public function getRespuestasExcel(){
        if ($this->tipo == 'basico') {
            return $this->hasMany('App\Models\PruebaExcelSoloRespuestaBasico', 'respuesta_user_id', 'id');
        } else if ($this->tipo == 'intermedio') {
            return $this->hasMany('App\Models\PruebaExcelSoloRespuestaIntermedio', 'respuesta_user_id', 'id');
        }
        return null;
    }
    ...
    public function configuracionReq() {
        return $this->hasOne('App\Models\PruebaExcelSoloConfiguracion', 'req_id', 'req_id');
    }
