...
class DatosBasicos extends Model
{
    ...
    {
        return $this->hasOne('App\Models\DatosAprendiz', "id", "datos_basicos_id");
    }
    ...
    {
        ( isset($cedula) && $cedula != '' ) ? $query->where('numero_id', $cedula) : $query;
    }

    public function scopeRangoFecha($query, $fecha_inicio, $fecha_final)
    {
        if ($fecha_inicio != "" && $fecha_final != "") {
            return $query->whereBetween("datos_basicos.fecha_acepto_politica", [$fecha_inicio, $fecha_final]);
        }else{
            return $query;
        }
    }
