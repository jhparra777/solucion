...
class ExperienciasController extends Controller
{
    ...
    public function index()
    {
        ...
        $experiencias = Experiencias::join('cargos_genericos','cargos_genericos.id','=','experiencias.cargo_desempenado')->where("user_id", $this->user->id)->select('cargos_genericos.descripcion as cargo_exp','experiencias.*')->get();
    ...
    public function editar_experiencia(Request $data)
    {
        ...
        ->select("cargos_genericos.descripcion AS nombre_cargo")
        ->where("cargos_genericos.id", $experiencia->cargo_desempenado)->first();
