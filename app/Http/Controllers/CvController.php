...
class CvController extends Controller
{
    ...
    public function lista_hv_admin(Request $data)
    {
        ...
        ->leftjoin('prueba_valores_1_respuestas_general', 'prueba_valores_1_respuestas_general.user_id', '=', 'datos_basicos.user_id')
        ->leftjoin('prueba_competencias_sola_resultados', 'prueba_competencias_sola_resultados.user_id', '=', 'datos_basicos.user_id')
        ->where(function ($where) use ($campos) {
            ...
            'prueba_valores_1_respuestas_general.id as id_valores_general',
            'prueba_competencias_sola_resultados.id as id_competencias_sola',
            DB::raw("(select prueba_excel_solo_respuestas_user.id from prueba_excel_solo_respuestas_user where prueba_excel_solo_respuestas_user.tipo = 'basico' and prueba_excel_solo_respuestas_user.user_id=datos_basicos.user_id LIMIT 1) as id_excel_basico"),
            DB::raw("(select prueba_excel_solo_respuestas_user.id from prueba_excel_solo_respuestas_user where prueba_excel_solo_respuestas_user.tipo = 'intermedio' and prueba_excel_solo_respuestas_user.user_id=datos_basicos.user_id LIMIT 1) as id_excel_intermedio")
        )
        ->groupBy(
            'datos_basicos.numero_id',
            'datos_basicos.user_id',
