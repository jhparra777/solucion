...
class VisitasDomiciliariasController extends Controller
{
    public function index(Request $data)
    {
        ...
        ->select("datos_basicos.*","visitas_candidatos.created_at as fecha_creacion","visitas_candidatos.requerimiento_id","visitas_candidatos.id as id_visita","visitas_candidatos.gestionado_candidato","clase_visita.descripcion as clase")
        ->paginate(10);
    ...
    public function gestionarVisita($id)
    {
        
        $candidato=VisitaCandidato::join("datos_basicos","datos_basicos.user_id","=","visitas_candidatos.candidato_id")
        ->join("tipos_visitas","tipos_visitas.id","=","visitas_candidatos.tipo_visita_id")
    ...
    public function realizarVisitaAdmin($visita_id,$edit=false){
        ...
        $claseLibreta       = ["" => "Seleccionar"] + ClaseLibreta::where("active", 1)->pluck("descripcion", "id")->toArray();
         ...
         $nivelEstudios=NivelEstudios::pluck("descripcion","id")->toArray();
    ...
    public function realizarPreFormVisita($visita_id,Request $request){
        ...
        return view("cv.visita.realizar_pre_form_visita", compact('candidatos','logo',"estadoCivil","claseLibreta","tipoVivienda","sector","material_techo","material_paredes","material_piso","tipo_familia","current_user","familiares","parentescos","tipoPropiedad","medioTransporte","bancos","tipos_credito","tipos_inmuebles","tipos_vehiculos","frecuencia","paises","dptos_expedicion","ciudades_expedicion","dptos_residencia","ciudades_residencia","nivelEstudios","tipos_tarjeta","localidades","imagenes"));
