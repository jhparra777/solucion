...
class NuevaHvAdminController extends Controller
{
    ...
    public function datos_basicos(Request $data)
    {
        ...
        #//Experiencia
        $experiencias       = Experiencias::join("cargos_genericos", function ($join3) {
               $join3->on("experiencias.cargo_desempenado", "=", "cargos_genericos.id");
                })->select("experiencias.*","cargos_genericos.descripcion AS nombre_cargo")->where("user_id", $this->user->id)->get();
    ...
    */
    ...
    public function guardar_estudios(Request $data)
    {
        //Validar campos reqeuridos
         ...
         $validador = Validator::make($data->all(),
            [
              ...
              "estudio_actual"     => "required_without_all:tiene_estudio",
              "titulo_obtenido"    => "required_without_all:tiene_estudio",
              "institucion"        => "required_without_all:tiene_estudio",
              //"fecha_finalizacion_es" => "required_unless:estudio_actual,2",
        ...
        if(!isset($data->tiene_estudio)){
            ...
            //$estudios->fecha_finalizacion = $data->fecha_finalizacion_es;
            $estudios->save();
    ...
    public function guardar_experiencia(Request $data)
    {
        ...
        if(isset($data->tiene_experiencia)) {
            ...
            $validador = Validator::make($data->all(), [
                ...
                "fecha_final"               => "date|required_if:empleo_actual,2|after:fecha_inicio",
                "salario_devengado"         => "required|numeric",
                "motivo_retiro"             => "required_if:empleo_actual,2",
            ...
            $cargo = Experiencias::join("cargos_genericos", function ($join3) {
                $join3->on("experiencias.cargo_desempenado", "=", "cargos_genericos.id");
            })
            ->select("cargos_genericos.descripcion AS nombre_cargo")
            ->where("cargos_genericos.id", $nuevaExperiencia->cargo_desempenado)
            ->first();
            ...
            $nuevaExperiencia->textcargo = $txtCargo;
            ...
            $mensaje ="Se ha guardado correctamente la experiencia.";

            return response()->json(["mensaje_success" => $mensaje, "success" => true, "rs" => $nuevaExperiencia, "tiene_experiencia" => 1]);
        }
    }
    ...
    public function editar_estudio(Request $data)
    {
        ...
        return response()->json(["data" => $campos,"ciudad_estudios" => $ciudad_estudios]);
    }
    ...
    public function editar_experiencia(Request $data)
    {
        ...
        ->select("cargos_genericos.descripcion AS nombre_cargo")
        ->where("cargos_genericos.id", $experiencia->cargo_desempenado)
        ->first();
    ...
    public function actualizar_estudio(Request $data)
    {
        $validador = Validator::make($data->all(),[
            ...
            "estudio_actual"     => "required",
            "titulo_obtenido"    => "required",
            "institucion"        => "required",
            "ciudad_estudio"     => "required",
            "fecha_finalizacion_es" => "required_if:estudio_actual,2",
        ]);
       ...
       if ($data->get('empleo_actual') == '1') {
        ...
        $validador = Validator::make($data->all(),[
            ...
            "cargo_desempenado"  =>  "required",
                    ...
                    //"fijo_jefe"                 => "numeric",
            "fecha_inicio"              => "required|date",
            "fecha_final"               => "date|required|after:fecha_inicio",
            "salario_devengado"         => "required|numeric",
        ...
        $experiencia->nivel_cargo = $data->nivel_cargo;
        ...
        $experiencia  = new Experiencias();
            ...
            $cargo = Experiencias::join("cargos_genericos", function ($join3) {
               $join3->on("experiencias.cargo_desempenado", "=", "cargos_genericos.id");
                ...
                ->select("cargos_genericos.descripcion AS nombre_cargo")
                ->where("cargos_genericos.id", $experiencia2->cargo_desempenado)->first();
            ...
            $experiencia2->textcargo = $txtCargo;
