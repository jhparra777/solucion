...
class AuthController extends Controller
{
    ...
    public function getLogin(Request $request)
    {
        ...
        //viene para consulta sst
        if ($request->has('ev_sst')) {
            $ev_sst = $request->ev_sst;
           // $candidato = $request->candidato;
            
            return view('cv.login', compact("menu", "ev_sst"));
        }
    ...
    public function postLogin(Request $request)
    {
        ...
        try {
            ...
            if($request->has('ev_sst')) {
                return redirect()->route("realizar_evaluacion_sst");
            }
