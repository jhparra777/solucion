...
class PruebaCompetenciasController extends Controller
{
    ...
    public function store(Request $data)
    {
        ...
        $inversas = $data->inversas; //Arreglo con el total de las preguntas indicando con 0 y 1 si es inversa
        ...
        // Recorrer el total de preguntas
        for($i = 0; $i < count($inversas); $i++) {
            //Solo se tiene en cuenta las preguntas que son directas, 0
            if($inversas[$i] != 1) {
                /**
                 * - Se usa el id de la competencia como indice de cada elemento
                 * - Se busca el código de la pregunta en la información que tiene la vista para tomar el valor de la opción seleccionada
                 */
