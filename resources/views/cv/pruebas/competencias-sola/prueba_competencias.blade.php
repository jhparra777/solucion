...
@section('content')
        ...
        <div class="row">
            <div class="question-paginate">
                ...
                <div class="col-md-12 mt-2 mb-4 text-center" id="buttonBox" hidden>
                    <button type="button" class="btn btn-success btn-lg" id="saveTest" data-route="{{ route('cv.prueba_competencias_guardar_sola') }}">Finalizar prueba</button>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('js/cv/pskills-sola/prueba-ps-webcam.js') }}"></script>
    <script src="{{ asset('js/cv/pskills-sola/prueba-ps.js') }}"></script>
