...
<head>
	...
	<title>Preview Informe de prueba Psicotécnica virtual BRYG-A</title>
...
<body>
	...
	<main class="main">
		...
		<h3 class="text-center">Preview Informe de Prueba Psicotécnica</h3>
		...
		<section>
			<div class="text-justify">
				<p>
					Bienvenido, en {{ ucfirst($sitio_informacion->nombre) }} hemos preparado un informe personalizado referente a la evaluación psicotécnica realizada. Para un mejor entendimiento de los resultados te resaltamos las principales características sobre las cuales nos basamos:
				</p>
			</div>
		</section>
