...
@section('content')
    ...
    <?php
        ...
        $validaTipoLogin = isset($evaluacion_sst) || isset($ev_sst) || isset($flag) || isset($record) || isset($brig) || isset($scheduling) || isset($excel_basico) || isset($excel_intermedio) || isset($digitacion) || isset($competencias) || isset($prueba_ethical_values) || isset($visita_domiciliaria) || session('url_deseada_redireccion_candidato') != null;
