                            ...
                            <div class="row">
                                ...
                                @if(route('home') != "https://gpc.t3rsc.co" )
                                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        {!! Form::number("telefono_temporal",null,["class"=>"form-control", "id"=>"telefono_temporal", "placeholder"=>"Telefono Empresa","maxlength"=>"10"]) !!}
                                    </div>
                                @endif
                                ...
                                @if(route('home')!= "http://tiempos.t3rsc.co" && route('home') != "https://tiempos.t3rsc.co")
                                    ...
                                    @if(route('home') != "http://colpatria.t3rsc.co" && route('home') != "https://colpatria.t3rsc.co" )
                                        ...
                                        @if(route('home') != "https://gpc.t3rsc.co")
                                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                              <label> Teléfono móvil jefe: </label><span></span>
                                               {!! Form::number("movil_jefe",null,["class"=>"form-control solo-numero","id"=>"movil_jefe", "placeholder"=>"Movil Jefe","maxlength"=>"10" ]) !!}
                                              <p style="display:none;"></p>
                                            </div>

                                            <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                              <label>Teléfono fijo jefe: </label><span></span>
                                                <div class="col-md-8"> 
                                                 {!!Form::number("fijo_jefe",null,["class"=>"form-control solo-numero","id"=>"fijo_jefe", "placeholder"=>"Fijo Jefe","maxlength"=>"10"])!!}
                                                </div>
                                                <div class="col-md-4"> 
                                                    {!! Form::number("ext_jefe",null,["class"=>"form-control", "id"=>"ext_jefe", "placeholder"=>"Extension Fijo"]) !!}
                                                </div>
                                              <p></p>
                                            </div>
                                        @endif
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="ocultar hidden form-group col-md-6 col-sm-12 col-xs-12">
                                        <label>
                                            @if(route('home') == "https://gpc.t3rsc.co")
                                                Fecha salida
                                            @else
                            ...
                            {!! Form::open(["id"=>"grilla"]) !!}
                                <div class="grid-container table-responsive">
                                    <table class="table table-striped" id="tbl_experiencias">
                                        <thead>
                                            <tr>
                                              <th style="text-align:center;"> Empresa
                                              ...
                                              <th style="text-align:center;">Cargo @if(route('home') == "https://gpc.t3rs.co") supervisor @endif </th>


                                                @if(route('home') != "https://gpc.t3rs.co")
                                                  <th style="text-align:center;">Teléfono empresa
                                                   @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co")
                                                ...
                                                @endif
                                                    ...
                                                    <th style="text-align:center;">Nombres @if(route('home') != "https://gpc.t3rs.co") jefe inmediato @else supervisor @endif </th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($experiencias as $experiencia)
                                              ...
                                              <tr id="tr_{{$experiencia->id}}">
                                                ...
                                                @if(route('home') != "http://colpatria.t3rs.co" && route('home') != "https://colpatria.t3rcs.co" && route('home') != "http://tiempos.t3rs.co" && route('home') != "https://tiempos.t3rs.co" )
