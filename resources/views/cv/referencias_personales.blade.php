                ...
                {!! Form::open(["class"=>"form-horizontal form-datos-basicos" ,"role"=>"form","id"=>"fr_referencias_personales"]) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-12">
                            ...
                            <div class="col-sm-6 col-lg-12 hidden">
                                <div class="form-group">
            ...
            $(document).on("click","#guardar_referencia", function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        tr.append($("<td></td>", {text: campos.ocupacion}));
                ...
                if (id) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            tr.eq(4).html(campos.ocupacion);
                            tr.eq(5).html(relacion.descripcion);
                            tr.eq(6).html($("<td></td>", {html: '<input type="hidden" name="id" value="'+campos.id+'"><button type="button" class="btn btn-primary btn-peq editar_referencia disabled_referencia"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-danger btn-peq eliminar_referencia disabled_referencia"><i class="fa fa-trash"></i></button>'}));
