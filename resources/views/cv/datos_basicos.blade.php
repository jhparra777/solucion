...
@section('content')
                            ...
                            <div class="row">
                                ...
                                @if(route('home') != "http://komatsu.t3rsc.co" && route('home') != "https://komatsu.t3rsc.co")
                                    ...
                                    @if(route('home') != "http://colpatria.t3rs.co" && route('home') != "https://colpatria.t3rs.co" &&
                                        route('home') != "http://tiempos.t3rs.co" && route('home') != "https://tiempos.t3rs.co" &&
                                        route('home')!="https://expertos.t3rs.co")
                                ...
                                @if((route("home") != "http://komatsu.t3rsc.co") && (route("home") != "https://komatsu.t3rsc.co") && (route('home') != "http://pta.t3rsc.co") && (route('home') != "https://gpc.t3rsc.co"))
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                     <label> Barrio <span>*</span></label>
                                      ...
                                      {!!Form::text("barrio",null,["class"=>"form-control","id"=>"barrio","placeholder"=>"", "required" => "required"])!!}
                                        ...
                                        route('home') != "http://colpatria.t3rsc.co" || route('home') != "https://colpatria.t3rsc.co")
                                            ...
                                            <div id="situacion_militar">
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    {!!Form::select("situacion_militar_definida",[""=>"Seleccionar","1"=>"si","0"=>"no"],$datos_basicos->situacion_militar_definida,["class"=>"form-control militar_situacion selectcategory", "id" => "situacion_militar_definida"])!!}
    ...
    @if ( $datos_basicos->politicasPrivacidad()->count() == 0 )
        <script>
            const msgModalPolities = `Para continuar con el uso de nuestra plataforma, debes aceptar nuestras políticas de privacidad. 
            
            <a class="btn btn-link" target="_blank" href="http://www.solucionesinmediatas.com.co/index.php/quienes-somos/2016-10-04-21-34-37" style="font-weight: bold; display: block;">Ver políticas SOLUCIONES INMEDIATAS</a>

            <a class="btn btn-link" style="font-weight: bold; display: block;" type='button' data-toggle='modal' data-target='#modal_polities' href='#'>Ver políticas T3RS</a>`
        </script>
    @elseif( $datos_basicos->politicasPrivacidad()->count() < $cantidad_politicas )
        <script>
            const msgModalPolities = `Hemos actualizado nuestra política de privacidad, para continuar con el uso de nuestra plataforma por favor haz clic en aceptar. 
            ...
            $("#guardar_datos_basicos").on("click", function () {
                ...
                $.ajax({
                    ...
                    error:function(data){
                        ...
                        var nombres = `${$("#primer_nombre").val()} ${$("#segundo_nombre").val()}`;
