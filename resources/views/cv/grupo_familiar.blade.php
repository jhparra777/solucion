                            ...
                            <div class="col-sm-6 col-lg-12">
                                <div class="form-group">
                                    <label for="tipo_documento" class="col-md-4 control-label">
                                        ...
                                        @if(route('home') != "https://listos.t3rs.co" &&route('home') != "https://vym.t3rs.co")
                                ...
                                <div id="fecha_nac" class="col-sm-6 col-lg-12">
                                    <div class="form-group">
                                        <label for="fecha_nacimiento" class="col-md-4 control-label">
                                            ...
                                            @if(route("home") == "http://colpatria.t3rs.co" || route("home") == "https://colpatria.t3rs.co") /Birth Date @endif : 
                                            @if(route('home') != "https://listos.t3rs.co" && route('home') != "https://vym.t3rs.co") <span class='text-danger sm-text-label'>*</span> @endif
                        ...
                        <table class="table table-striped" id="tbl_familia">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;"> Nombres @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co")/Name @endif </th>

                                    <th style="text-align:center;">
                                     Apellidos @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co")/Surname @endif </th>
                                    ...
                                    @else
                                      ...
                                      <th style="text-align:center;">
                                       Género @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co") /Gender @endif
                                      </th>

                                      <th style="text-align:center;">
                                        Fecha nacimiento @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co") /Birth Date @endif
                                      </th>
                                    
                                      <th style="text-align:center;">
                                        Escolaridad @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co") /Study @endif
                                      </th>
                                    @endif
                                ...
                                @foreach($familiares as $familiar)
                                    <tr id="tr_{{$familiar->id}}">
                                      ...
                                      <td>{{$familiar->primer_apellido." ".$familiar->segundo_apellido}}</td>
                                        ...
                                        @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co" || route('home') == "http://tiempos.t3rs.co" || route('home') == "https://tiempos.t3rs.co" ||
                                        route('home') == "http://nases.t3rs.co" || route('home') == "https://nases.t3rs.co" || route('home') == "https://gpc.t3rs.co" || route('home') == "http://localhost:8000")
                        ...
                        $(document).ready(function(){
                            swal("Nuevo grupo familiar guardado", " ¿Desea agregar otro familiar?", "info", {
                                ...
                                switch (value) {
                                    ...
                                    case "agregar":
                                      window.location.href = '{{route('cv.idiomas').'#fr_idioma'}}';
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                          ...
                          $(".disabled_familiar").prop("disabled", false);
                            ...
                            @if(route('home') != "http://colpatria.t3rs.co" && route('home') != "https://colpatria.t3rs.co")
                           ...
                           //tr.eq(6).html(ciudad.ciudad);
                            ...
                            tr.eq(6).html($("<td></td>", {html: '<input type="hidden" name="id" value="'+campos.id+'"><button type="button" class="btn btn-primary btn-peq editar_familiar disabled_familiar"><i class="fa fa-pencil"></i></button> <button type="button" class="btn btn-danger btn-peq eliminar_familiar disabled_referencia"><i class="fa fa-trash"></i></button>'}));
