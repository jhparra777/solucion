                        ...
                        {!! Form::open(['id'=>"fr_pre",'route' => 'process_registro',"autocomplete"=>"off", "files"=>true]) !!}
                            ...
                            <div class="form-group">
                                <label for="acepto_politicas_privacidad_soluciones">
                                    Aceptar política de privacidad SOLUCIONES INMEDIATAS
                                </label>

                                {!! Form::checkbox('acepto_politicas_privacidad_soluciones', 1, false, ['class' => 'checkbox-preferencias', 'id' => 'acepto_politicas_privacidad_soluciones', 'required']) !!}
                                
                                <span style="color: red;">*</span>

                                <a target="_blank" href="http://www.solucionesinmediatas.com.co/index.php/quienes-somos/2016-10-04-21-34-37" class="btn btn-primary btn-xs"> Ver política de protección de datos</a>
                            ...
                            <div class="form-group">
                                <label for="acepto_politicas_privacidad">
                                    Aceptar política de privacidad T3RS
                                </label>
                                ...
                                <button id="activaBotonesModal" type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> Ver política de protección de datos</button>
