...
<body>
    ...
    <table class="center table-contract justify mt-2" width="95%">
        ...
        <tr>
            <td>
                <p>
                    Para constancia se firma en dos ejemplares del mismo tenor y valor, en la ciudad y fecha que se indican a continuación. BOGOTA, {{ $dias_semana[date('N')] }} {{ date('d') }} de {{ $meses[date('n')] }} del {{date('Y')}}.</p>
            </td>
        </tr>
    </table>
