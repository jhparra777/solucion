...
@section('contenedor')
    ...
    {{-- HEADER --}}
    @include('req.layout.includes._section_header_breadcrumb', ['page_header' => "Documentos post contratación | $datos_candidato->nombres $datos_candidato->primer_apellido $datos_candidato->segundo_apellido", 
