...
@section('contenedor')
	...
	<div class="row pt-2">
		<div class="col-xs-6">
			<div
				...
				<a class="tri-py-2" href="{{route('req.documentos_seleccion_cliente', ['candidato' => $candidato, 'req' => $req, 'req_can' => $candi_req->id])}}">
		...
		<div class="col-xs-6">
			<div
				...
				<a class="tri-py-2" href="{{ route('req.documentos_contratacion_cliente', ['candidato'=> $candidato, 'req' => $req])}}">
	...
	<div class="row pt-2">
		<div class="col-xs-6">
			<div
				class="small-box bg-aqua | tri-small-box tri-shadow-light @if($porcentaje_confidencial == 0) tri-bl-red @elseif($porcentaje_confidencial == 100) tri-bl-green @else tri-bl-yellow @endif tri-transition-300 tri-bg-white">
				<a class="tri-py-2" href="{{route('req.documentos_confidenciales', ['candidato'=> $candidato, 'req' => $req])}}">
					<div class="inner">
						<div class="row">
							<div class="col-sm-1" style="height: 110px;">
								<span
									class="@if($porcentaje_confidencial == 0) tri-red @elseif($porcentaje_confidencial == 100) tri-green @else tri-yellow @endif text-white tri-px-05">{{$porcentaje_confidencial}}%</span>
							</div>
							<div class="col-sm-11">
		...
		<div class="col-xs-6">
			<div
				class="small-box bg-aqua | tri-small-box tri-shadow-light @if($porcentaje_post == 0) tri-bl-red @elseif($porcentaje_post == 100) tri-bl-green @else tri-bl-yellow @endif tri-transition-300 tri-bg-white">
				<a class="tri-py-2" href="{{ route('req.documentos_post', ['candidato' => $candidato, 'req' => $req])}}">
					<div class="inner">
						<div class="row">
							<div class="col-sm-1" style="height: 110px;">
								<span
									class="@if($porcentaje_post == 0) tri-red @elseif($porcentaje_post == 100) tri-green @else tri-yellow @endif text-white tri-px-05">{{$porcentaje_post}}%</span>
							</div>
							<div class="col-sm-11">
