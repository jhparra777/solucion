...
@else
  ...
  <h4 class="titulo1">INFORMACIÓN GENERAL DE LA SOLICITUD</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">SERCON</label>
        <div class="col-sm-8">
          {{isset($requerimiento->sercon) ? $requerimiento->sercon->descripcion : ""}}
        </div>
      </div>
    </div>
    ...
    <div class="row">
     ...
     @if(!empty($requerimiento->getTipoTrabajo()))
      <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Tipo Trabajo</label>
        <div class="col-sm-8">
          {{$requerimiento->getTipoTrabajo()->descripcion}}
        </div>
      </div>
     @endif
     ...
     @if( $requerimiento->tipo_contrato_id == 6 )
        <div class="col-md-6 form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Días de la semana</label>
          <div class="col-sm-8">
            {{$requerimiento->dias_semana_teletrabajo->descripcion}}
          </div>
        </div>
        ...
        <div class="col-md-6 form-group">
          ...
          <div class="col-sm-8">
            <b>Mañana:</b>{{$requerimiento->horario_teletrabajo->dia}}
            <br/>
            <b>Tarde:</b>{{$requerimiento->horario_teletrabajo->tarde}}
          </div>
        </div>

        <div class="col-md-6 form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Tipo teletrabajador</label>
          <div class="col-sm-8">
            {{$requerimiento->tipo_teletrabajador->descripcion}}
          </div>
        </div>

        <div class="col-md-6 form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Descanso</label>
          <div class="col-sm-8">
            {{$requerimiento->descanso_teletrabajador->descripcion}}
          </div>
        </div>

        <div class="col-md-6 form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Días de teletrabajo</label>
          <div class="col-sm-8">
            {{$requerimiento->dias_teletrabajo->descripcion}}
          </div>
        </div>

        <div class="col-md-6 form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Días de trabajo en oficina</label>
          <div class="col-sm-8">
            {{$requerimiento->dias_trabajo_oficina->descripcion}}
          </div>
        </div>
      @endif
