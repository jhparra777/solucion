    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="inputEmail3" class="control-label">
                        Requisición de Servicio: <span class='text-danger sm-text-label'>*</span>
                    </label>
            ...
            <div class="col-md-6">
                <div class="form-group @error('tipo_trabajo') has-feedback has-error smk-select @enderror">
                    <label for="tipo_trabajo_id" class="control-label">Tipo Trabajo<span>*</span></label>
                    {!!Form::select("tipo_trabajo_id",[""=>"Seleccionar"],null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"tipo_trabajo", "required"=>"required"]);!!}
            ...
            <div class="col-md-6">
                <div class="form-group @error('sercon_id') has-feedback has-error smk-select @enderror">
                    <label for="motivo_requerimiento_id" class="control-label">SERCON: <span class='text-danger sm-text-label'>*</span></label>
