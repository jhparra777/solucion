...
@section('contenedor')
    ...
    {!! Form::model(Request::all(),["route" => "admin.reportes_enviados_exam_medicos", "method" => "GET", "id" => "filter_form", "accept-charset" => "UTF-8"]) !!}
        ...
        <a class="btn btn-warning" href="{{ route('admin.reportes_enviados_exam_medicos') }}">
            Limpiar
        </a>
    {!! Form::close() !!}
        ...
        $(function () {
            $('#export_excel_btn').click(function(e){
                ...
                $(this).prop(
                    ...
                    "&candidatos_archivos="+candidatos_archivos+"&formato=xlsx&rango_fecha="+rango_fecha+"&numero_id="+numero_id
                );
            });
        })
    </script>
