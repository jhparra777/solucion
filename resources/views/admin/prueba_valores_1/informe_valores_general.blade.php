	...
	<main class="mx-100">
		...
		<section>
			<div class="text-justify">
				<p>
					Bienvenido, hemos preparado un informe personalizado referente a la evaluación psicotécnica realizada a {{ $candidato_valores->nombre_completo }}, quien es una de las personas registradas en el portal. Para un mejor entendimiento de los resultados te resaltamos las principales características sobre las cuales nos basamos:
				</p>
			</div>
		</section>
		...
		<?php
            ...
            $ruta = 'recursos_prueba_valores_1/prueba_valores_1_'.$candidato_valores->user_id;
        ?>
        {{-- Separar contenido a nueva hoja --}}
        <div class="page-break"></div>
		<section>
