                            ...
                            @if($requerimiento->estado_publico == 1 && $requerimiento->estado_requerimiento != config('conf_aplicacion.C_TERMINADO'))
                                <td>
                                    <div class="container" style="width: 250px;">
                                        ...
                                        <div class="row" style="width: 250px;">
                                            <div style="width:250px; ">
                                                <script type="IN/Share" data-url="{{ route('home.detalle_oferta', ['oferta_id' => $requerimiento->req_id]) }}" data-href="{{route('home.detalle_oferta', ['oferta_id' => $requerimiento->req_id])  }}"></script>
