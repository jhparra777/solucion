        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="page-header">
                                <h4 class="tri-fw-600">
                                    ...
                                    <a type="button" class="btn btn-warning | tri-br-2 tri-fs-12 tri-txt-blue tri-bg-white tri-bd-blue tri-transition-300 tri-hover-out-greeny pull-right" href="{{route('admin.visita.gestionar_informe',['id_visita'=>$candidato->id_visita])}}" target="_blank">Generar informe</a>
                                </h4>
                    ...
                    <h5 class="titulo1">Información de la visita</h5>
                    
                    <table class="table table-bordered">
                        <tr>
                            <th>Tipo visita</th>
                            <td>{{$candidato->tipo_visita}}</td>
                            <th>Clase visita</th>
