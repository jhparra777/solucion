                   ...
                   <button 
                    ...
                    <ul class="dropdown-menu">
                        @if ($firmaContrato->contrato !== null || $firmaContrato->contrato !== '')
							<a type="button" class="btn btn-default btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none" href="{{route('generar_carnet', $req_cand->id)}}" target="_blank"> Carnet Candidato </a>
						@endif
