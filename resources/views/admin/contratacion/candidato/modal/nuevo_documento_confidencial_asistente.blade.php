...
<div class="modal-body">
    ...
    {!! Form::model(Request::all(), ["id" => "fr_nuevo_documento_confidencial", "files" => true, "data-smk-icon" => "glyphicon glyphicon-remove"]) !!}
    ...
    <script>
        $(function(){
            ...
            $("#guardar_nuevo_doc_conf").on("click", function(){
                ...
                if ($('#fr_nuevo_documento_confidencial').smkValidate()){
                    var formData = new FormData(document.getElementById("fr_nuevo_documento_confidencial"));
