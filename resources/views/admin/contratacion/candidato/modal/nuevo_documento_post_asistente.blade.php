        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::file("archivo_documento[]",["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "accept"=>".pdf,.doc,.docx,.png,.jpg,.jpeg,.xls,.xlsx", "multiple"=>"true", "required" => "required"]) !!}
