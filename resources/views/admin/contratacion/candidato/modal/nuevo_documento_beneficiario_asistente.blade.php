...
<div class="modal-body">
	{!! Form::open(["class"=>"form-horizontal form-datos-basicos", "role"=>"form","files"=>true,"id"=>"fr_nuevo_documento_beneficiario"]) !!}
        <div class="modal-body">
            ...
            <div class="col-sm-6 col-lg-12 form-group">
                <label for="descripcion" class="col-md-4 control-label">Observaciones:<span class='text-danger sm-text-label'>*</span> </label>
                                
                <div class="col-md-6">
                    {!! Form::text("descripcion",null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","placeholder"=>"Observaciones Documento","id"=>"descripcion"]) !!}
                </div>
            </div>
