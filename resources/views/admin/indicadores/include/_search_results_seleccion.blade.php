                                            ...
                                            <tbody>
                                                @foreach($requerimientos_rango as $req)
                                                    <tr class="text-center">
                                                        ...
                                                        <td>{{$req->residuo}}</td>
                                                        <td>
                                                            @if($req->cantidad && $req->cantidad>$req->residuo)
                                                                {{round($req->cant_contratados*100/($req->cantidad-$req->residuo),2)}}
                                                            @else
                                                                0
                                                            @endif
                                                        </td>
                                                ...
                                                @endforeach
                                                    <tr class="text-center">
                                                        ...
                                                        <th class="text-center">{{$requerimientos_rango->sum('residuo')}}</th>
                                                        <th class="text-center">
                                                            @if($requerimientos_rango->sum('cantidad'))
                                                            {{round($requerimientos_rango->sum('cant_contratados')*100/($requerimientos_rango->sum('cantidad')-$requerimientos_rango->sum('residuo')),2)}}
                                                            @endif
                                                        </th>
                                                    </tr>
                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            <table class="table table-striped text-center">
                               ...
                               <tr class="text-center">
                                ...
                                <tr class="text-center">
                                    <th class="text-center">Canceladas rango actual</th>
                                    <th class="text-center" colspan="2" style="color: red;">{{$requerimientos_rango->sum('residuo')}}</th>
                                ...
                                <tr class="text-center">
                                    ...
                                    <th class="text-center" colspan="2">{{$requerimientos_rango->sum('cantidad')+ $requerimientos_anteriores->sum('cantidad')- $requerimientos_rango->sum('residuo')}}</th>
