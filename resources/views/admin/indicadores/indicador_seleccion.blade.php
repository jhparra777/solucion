...
<div class="container">
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="col-md-6">
                <label for="inputEmail3" class="control-label">Fecha creación de requerimientos:</label>
