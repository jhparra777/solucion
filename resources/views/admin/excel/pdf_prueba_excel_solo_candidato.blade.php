        ...
        <main class="mx-100">
            ...
            <section>
                <div class="text-justify">
                    <p>
                        Prueba realizada el {{ $respuesta_user->formatoFecha($respuesta_user->fecha_respuesta) }}.
                    </p>
                </div>
            </section>
            ...
            <?php
                ...
                if ($respuesta_user->tipo == 'basico') {
                    $ruta = 'recursos_prueba_excel_solo/prueba_excel_basico_'.$respuesta_user->user_id;
                } else if ($respuesta_user->tipo == 'intermedio') {
                    $ruta = 'recursos_prueba_excel_solo/prueba_excel_intermedio_'.$respuesta_user->user_id;
                }
            ?>
