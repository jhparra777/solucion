        ...
        <td>
            ...
            switch ($ref->apto) {
                ...
                case 3:
                  ...
                  if(route("home") == "http://komatsu.t3rs.co" || route("home") == "https://komatsu.t3rs.co" || route("home") == "http://desarrollo.t3rs.co"){
                    ...
                    <div class="referencia">
                        <table class="table table-bordered tbl_info" style="margin-bottom: 0px">
                            <tr>
                              ...
                              <td style="width:30%;">{{$ref_personales->nombres}}</td>
                              <th style="width:30%;">Primer Apellido</th>
                              <td style="width:30%;">{{$ref_personales->primer_apellido}}</td>
                            </tr>
                            <tr>
                              <th style="width:30%;">Segundo Apellido</th>
                              <td style="width:30%;">{{$ref_personales->segundo_apellido}}</td>
                              <th style="width:30%;">Tipo relación</th>
                              <td style="width:30%;">{{$ref_personales->relacion}}</td>
                            </tr>
                            <tr>
                              <th style="width:30%;">Teléfono Móvil</th>
                              <td style="width:30%;">{{$ref_personales->telefono_movil}}</td>
                            </tr>
                            <tr>
                              <th style="width:30%;">Ciudad</th>
                              <td style="width:30%;">{{$ref_personales->ciudad_seleccionada}}</td>
                              <th style="width:30%;">Ocupación</th>
                              <td style="width:30%;">{{$ref_personales->ocupacion}}</td>
                            </tr>
