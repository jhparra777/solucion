            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-md-6">
                    ...
                    {!! Form::select("resultado", [
                            "" => "Seleccione",
                            1 => "Apto para el cargo",
                            2 => "Aplazado",
                            3 => "Apto con recomendaciones",
                            4 => "Apto con restricciones",
                            5 => "Apto para el cargo y apto para manipular alimentos",
                            6 => "Apto para el cargo y apto para trabajo en alturas",
                            7 => "Apto para el cargo y apto para brigadista",
                            8 => "Apto para el cargo y apto para conductor"
                        ], null,["class" => "form-control", "id" => "resultado"])
                    !!}
