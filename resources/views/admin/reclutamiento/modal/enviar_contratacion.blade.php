    ...
    @if(count($candidato) > 0)
        ...
        @if( isset($sitio) && $sitio->asistente_contratacion == 1 )
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-sm-8">
                    @if($dato_contrato)
                        <input type="text" name="centro_costos" value="{{ (!empty($dato_contrato->centro_costos)) ? $dato_contrato->centro_costos : $centro_costo->centro_costo }}" class="form-control" required>
                    @else
                        <input type="text" name="centro_costos" value="" class="form-control" required>
                    @endif
                </div>
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-sm-8">
                    <select id="fondo_cesantias" name="fondo_cesantias" class="form-control selectcategory" readonly="readonly">
