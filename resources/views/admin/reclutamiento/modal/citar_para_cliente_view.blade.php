<div class="modal-header">
    ...
    <h4 class="modal-title">Entrevista para cliente</h4>
</div>
<div class="modal-body">
    ...
    @if (count($cita) > 0)
        ...
        {!! Form::open(["id"=>"frm_modifica_cita"]) !!}
            ...
            <h4>Datos de cliente para asignar entrevista</h4>
...
<div class="modal-footer">
    ...
    @if (count($cita) > 0)
        <button type="button" class="btn btn-success" id="guardar_cita_to_cliente" >Entrevistar</button>
    @endif
