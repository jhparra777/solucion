...
<div class="modal-body">
    {!! Form::model(Request::all(), ["id" => "fr_documento_verificado", "data-smk-icon" => "glyphicon-remove-sign"]) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text("fecha_realizacion",null,[
                "class"=>"form-control",
        ...
        <div>
                 <span style="position: relative;top:-15px;"><strong>¿Entra en Seguimiento por SST SOLUCIONES INMEDIATAS?</strong></span>
                <label class="switchBtn">
                    {!! Form::checkbox("seguimiento",1,0,["class"=>"usar","id"=>"seguimiento"]) !!}
                <div class="slide"></div>
                </label>
        </div>
         ...
         <div class="form-group">
            ...
            {!! Form::text("email_cliente",null,[
                "class" => "form-control",
                "placeholder" => "ejemplo@ejemplo.com,ejemplo22@otro.com"
            ]) !!}
            <span style="color: rgb(190,190,190)">Ingrese los correos electrónicos separados por coma(,) </span>
        </div>
