        ...
        @else
            <div class="col-md-12 form-group">
                ...
                @if(route('home') == 'https://listos.t3rsc.co' || route('home') == 'http://localhost:8000')
                    <div class="col-sm-8">
                        {!! Form::text("fecha_ingreso_contra", ($dato_contrato) ? $dato_contrato->fecha_ingreso : $requerimiento->fecha_ingreso, [
                                "class" => "form-control",
            ...
            <div class="col-md-12 form-group">
                ...
                @if(route("home") == "https://soluciones.t3rsc.co" || route("home") == "https://pruebassoluciones.t3rsc.co")
                    <div class="col-sm-8">
                        {!! Form::select("user_autorizacion", $usuarios_clientes, ($dato_contrato) ? $dato_contrato->user_autorizacion : $contra_clientes->user_autorizacion, [
                                "class" => "form-control",
                                "id" => "user_autorizacion",
                                "required" => "required"
                            ]);
