                                ...
                                @else
                                    @if ($ref->observaciones)
                                        @if($ref->proceso === 'ENVIO_EXAMENES' && $ref->nombre_archivo != null && ($ref->apto == 1 || $ref->apto == 2 || $ref->apto == 0 || $ref->apto == 3))
                                            <td>
                                                <?php
                                                    echo ($ref->observacion_medica != null ? $ref->observacion_medica : $ref->observaciones.'<br>')."<a href=".asset("recursos_documentos_verificados/$ref->nombre_archivo")." target='_blank'><i class='fas fa-file-alt'></i> Ver Examen Médico</a>";
                                                ?>
                                            </td>
                                        @else
                                    ...
                                    @else
                                        <td>
                                            @if($ref->proceso === 'ENVIO_EXAMENES' && $ref->nombre_archivo != null && ($ref->apto == 1 || $ref->apto == 2 || $ref->apto == 3))
                                                <?php
                                                    echo ($ref->observacion_medica != null ? $ref->observacion_medica : '')."<a href=".asset("recursos_documentos_verificados/$ref->nombre_archivo")." target='_blank'><i class='fas fa-file-alt'></i> Ver Examen Médico</a>";
                                                ?>
                                            @endif
                                        </td>
                                    @endif
