@if( isset($sitio) && $sitio->asistente_contratacion == 1 )
    ...
    <div class="col-md-6 form-group">
        ...
        <div class="col-sm-12">
            @if($dato_contrato)
                <input type="text" name="centro_costos" value="{{ (!empty($dato_contrato->centro_costos)) ? $dato_contrato->centro_costos : $centro_costo->centro_costo }}" class="form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" required>
            @else
                <input type="text" name="centro_costos" class="form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" required>
            @endif
        </div>
    ...
    <div class="col-md-6 form-group">
        ...
        <div class="col-sm-12">
            <select id="fondo_cesantias" name="fondo_cesantias" class="form-control selectcategory | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" readonly="readonly">
                <option value="40">Control Interno</option>
            </select>
        </div>
