                        ...
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="width-perc"> Negocio </th>
                                    <td class="width-perc"> {{ $requermiento->num_negocio }} </td>
                                </tr>
                                <tr>
                                    <th class="width-perc"> Fecha Ingreso requerimiento </th>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <th class="width-perc"> Tipo Trabajo </th>
                                    <td colspan="3" class="width-perc"> 
                                        @if( $requermiento->getTipoTrabajo()!=null)
                                            {{ $requermiento->getTipoTrabajo()->descripcion }}
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="width-perc">
                                        {{ isset($requermiento->sercon) ? $requermiento->sercon->descripcion : "" }}
                                    </td>
                                </tr>

                                @if($requermiento->tipo_contrato_id == 6 )
                                    <tr>
                                        <th class="width-perc">
                                            Días de la semana
                                        </th>
                                        <td class="width-perc">
                                            {{$requermiento->dias_semana_teletrabajo->descripcion}}
                                        </td>
                                        ...
                                        <td class="width-perc">
                                            <b>Mañana:</b>{{$requermiento->horario_teletrabajo->dia}}
                                            <br/>
                                            <b>Tarde:</b>{{$requermiento->horario_teletrabajo->tarde}}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="width-perc">
                                            {{$requermiento->tipo_teletrabajador->descripcion}}
                                        </td>
                                        ...
                                        <td class="width-perc">
                                            {{$requermiento->descanso_teletrabajador->descripcion}}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="width-perc">
                                            {{$requermiento->dias_teletrabajo->descripcion}}
                                        </td>
                                        ...
                                        <td class="width-perc">
                                            {{$requermiento->dias_trabajo_oficina->descripcion}}
                                        </td>
                                    </tr>
                                @endif
