    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-12 form-group">
                ...
                <input type="number" name="celular" id="celular" class="form-control numerico editable | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" value="{{  (!empty($candidato->telefono_movil)) ? $candidato->telefono_movil : '' }}" required>
