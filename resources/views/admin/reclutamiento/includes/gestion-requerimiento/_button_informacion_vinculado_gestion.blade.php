    ...
    <ul class="dropdown-menu pd-0" role="menu" id="botones_de_informacion">
        ...
        <li>
            <a
                ...
                class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none" 
                target="_blank"
                href="{{route('admin.informe_entrevista_semi_pdf',['req_can'=>$candidato_req->req_candidato_id])}}"
                {!! ((funcionesglobales::validabotonprocesos($candidato_req->req_candidato_id, ["ENVIO_ENTREVISTA"]))? :"disabled = 'disabled'") !!}
                style="padding: .5rem 10px;"
            >
                ENTREVISTA SEMI PDF
            </a>
