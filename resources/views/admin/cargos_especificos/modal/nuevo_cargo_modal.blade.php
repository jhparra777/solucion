                                                ...
                                                {{-- @foreach($adicionales as $ad)
                                                    <div class="col-md-12">
                                                        <label style="font-size: 13px;">
                                                            <input type="checkbox" class="contratacion-clausulas" name="clausulas[]" value="{{$ad->id}}"  @if($ad->default) checked="true" @endif>
                                                            {{ $ad->descripcion }}
                                                        </label>
                                                    </div>
                                                @endforeach --}}
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.success) {
                            ...
                            swal(response.mensaje_success, "Puede continuar con el registro del requerimiento", "success");
