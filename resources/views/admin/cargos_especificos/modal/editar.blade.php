...
<div class="modal-body">
    {!! Form::model($registro, ["id" => "fr_cargos_especificos", "route" => "admin.cargos_especificos.actualizar", "method" => "POST", "files" => true]) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <label class="col-sm-2 control-label" for="inputEmail3">Nombre del cargo: </label>
                <div class="col-sm-10">
            ...
            <div class="col-md-12 form-group">
                @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co")
                    <label class="col-sm-2 control-label" for="inputEmail3">Área Laboral:</label>
                @else
                    <label class="col-sm-2 control-label" for="inputEmail3">Cargo Genérico:</label>
                @endif
            ...
            @else
                <div class="col-md-12 form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select("clt_codigo", $clientes, null, ["class" => "form-control", "id" => "cliente_select" ]); !!}
                    </div>
            ...
            @if($sitio->asistente_contratacion == 1)
                <div class="col-md-12 form-group">
                    <label class="col-sm-2 control-label" for="firma_digital">Contratación virtual *</label>
                    <div class="col-sm-10">
                        {!! Form::select("firma_digital", [1 => "Si", 0 => "No"], null, ["class" => "form-control", "id" => "firma_digital"]); !!}
                    </div>
                ...
                <div class="col-md-12 form-group" id="videos_box">
                    <label class="col-sm-2 control-label" for="videos_contratacion">¿Video confirmación? *</label>
