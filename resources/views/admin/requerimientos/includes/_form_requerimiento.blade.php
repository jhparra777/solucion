...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            {!! Form::hidden("empresa_contrata", 1, ["class" => "form-control", "id" => "empresa_contrata"]) !!}
            ...
            @if($sitioModulo->visita_domiciliaria == 'enabled')
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputEmail3" class="control-label">Visita domiciliaria?: <span class='text-danger sm-text-label'>*</span></label>

                        {!! Form::select("tipo_visita_id",$tipos_visitas,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "id" => "tipo_visita_id"]); !!}
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('tipo_nomina') has-feedback has-error smk-select @enderror">
                    ...
                    {!! Form::select("tipo_nomina",$tipo_nomina,($tipo_nomina_id != "" ? $tipo_nomina_id : 1),["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"tipo_nomina","required"]); !!}
            ...
            <div class="col-md-6">
                <div class="form-group @error('tipo_trabajo_id') has-feedback has-error smk-select @enderror">
                    <label for="tipo_trabajo_id" class="control-label">Tipo Trabajo: <span class='text-danger sm-text-label'>*</span></label>
                    {!!Form::select("tipo_trabajo_id",isset($tipoTrabajo) ? $tipoTrabajo : [""=>"Seleccinar"],null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"tipo_trabajo", "required"=>"required"]);!!}
            ...
            <div class="col-md-6">
                <div class="form-group @error('sercon_id') has-feedback has-error smk-select @enderror">
                    <label for="inputEmail3" class="control-label">SERCON: <span class='text-danger sm-text-label'>*</span></label>
                   {!!Form::select("sercon_id",$sercon,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"sercon_id", "required"=>"required"]);!!}
        ...
        <div id="solo_teletrabajo" class="hide">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Días de la semana: <span class='text-danger sm-text-label'>*</span></label>
                   {!!Form::select("dias_semana_teletrabajo_id",$dias_semana_teletrabajo,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"dias_semana_teletrabajo_id"]);!!}
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Horario: <span class='text-danger sm-text-label'>*</span></label>
                   {!!Form::select("horario_teletrabajo_id",$horario_teletrabajo,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"horario_teletrabajo_id"]);!!}
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Tipo teletrabajador: <span class='text-danger sm-text-label'>*</span></label>
                    {!!Form::select("tipo_teletrabajador_id",$tipos_teletrabajadores,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"tipo_teletrabajador_id"]);!!}
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Descanso: <span class='text-danger sm-text-label'>*</span></label>
                    {!!Form::select("descanso_teletrabajador_id",$descansos_teletrabajadores,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"descanso_teletrabajador_id"]);!!}
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Días de teletrabajo: <span class='text-danger sm-text-label'>*</span></label>
                    {!!Form::select("dias_teletrabajo_id",$dias_teletrabajo,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"dias_teletrabajo_id"]);!!}
                </div>
            </div>

            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Días de trabajo en oficina: <span class='text-danger sm-text-label'>*</span></label>
                    {!!Form::select("dias_trabajo_oficina_id",$dias_trabajo_oficina,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"dias_trabajo_oficina_id"]);!!}
                </div>
            </div>
        </div>
