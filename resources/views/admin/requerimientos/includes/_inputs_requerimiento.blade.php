            ...
            <h4 class="titulo1">ESPECIFICACIONES DEL REQUERIMIENTO</h4>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="col-sm-8">
                            {!!Form::select("tipo_trabajo_id",$tipoTrabajo,$requermiento->tipo_trabajo_id,["class"=>"form-control","id"=>"tipo_trabajo", "required"=>"required"]);!!}
                        </div>
                    </div>
                </div>
                ...
                <div id="solo_teletrabajo" class="row @if($requermiento->getTipoContrato()->modelo_contrato != 'teletrabajo') hide @endif">
                    <div class="col-md-6 form-group">
