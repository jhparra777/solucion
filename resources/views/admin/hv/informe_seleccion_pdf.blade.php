        ...
        @if(route('home') !="http://poderhumano.t3rsc.co")
            ...
            @if(route('home') == "https://komatsu.t3rsc.co" || route('home') == "http://komatsu.t3rsc.co" ||
                ...
                <h3 class="textCenter">Entrevista Semiestructurada</h3>
                  ...
                  <a type="button" style="width: 100%;text-decoration:none;" class="btn btn-sm btn-info" target="_blank" href="{{route("admin.informe_entrevista_semi_pdf",["req_can"=>$reqcandidato->requerimiento_cantidato_id])}}"> Ver entrevista(s) </a>
