        ...
        <div class="container">
            ...
            <div id="container_documentos_familiares">
                {!! Form::open(["class"=>"form-horizontal form-datos-basicos", "role"=>"form","files"=>true,"id"=>"fr_documento_familiar"]) !!}
                    ...
                    {!! Form::hidden("cand_id",$usuario->user_id) !!}
                    <div class="row">
                        <div class="col-sm-6 col-lg-12">
                         <div class="form-group">
                          <label for="tipo_documento" class="col-md-4 control-label">Tipo Documento:<span class='text-danger sm-text-label'>*</span></label>
                        ...
                        <div class="col-sm-6 col-lg-12">
                            <div class="form-group">
                                <label for="descripcion_documentos" class="col-md-4 control-label">Observaciones:<span class='text-danger sm-text-label'>*</span> </label>
                                
                                <div class="col-md-6">
                                    {!! Form::text("descripcion",null,["class"=>"form-control","placeholder"=>"Observaciones Documento","id"=>"descripcion"]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
