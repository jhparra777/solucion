            ...
            <div id="collapseEstudios" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                    ...
                    {!! Form::open(["route" => ["admin.hv_actualizada",$datos->basicos->user_id], "class" => "form-datos-basicos", "role" => "form", "id" => "fr_estudios"])!!}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="fecha_inicio">Fecha Inicio:  <span class='text-danger sm-text-label'>*</span> </label>
                                
                                {!! Form::text("fecha_inicio",null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","placeholder"=>"Fecha Inicio","id"=>"fecha_inicio_es"]) !!}
                            </div>
                        </div>
