                    ...
                    {!! Form::open(["class" => "form-datos-basicos", "role" => "form", "id" => "fr_datos_experiencia"]) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_inicio">
                                    Fecha inicio: <span class='text-danger sm-text-label'>*</span>
                                </label>
                        ...
                        <div class="ocultar col-md-6">
                            <div class="form-group">
                                <label for="fecha_terminacion">
                                    Fecha terminación: <span class='text-danger sm-text-label'>*</span>
                                </label>
                            ...
                            <div class="col-md-6" id="motivo_r">
                                <div class="form-group">
                                    <label for="motivo_retiro">
                                        Motivo retiro: <span class='text-danger sm-text-label'>*</span>
                                    </label>
                        ...
                        @if(route('home') != "https://gpc.t3rsc.co")
                            <div id="funciones" class="col-sm-6 col-lg-12">
                                <div class="form-group">
                                    <label for="funciones_logros">Funciones y logros: <span class='text-danger sm-text-label'>*</span></label>
