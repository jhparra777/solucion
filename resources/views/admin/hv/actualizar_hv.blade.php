                ...
                @else
                   ...
                   @if(route('home') != "http://komatsu.t3rsc.co" && route('home') != "https://komatsu.t3rsc.co")
                    ...
                    <div id="situacion_militar">
                      <div class="col-sm-6 col-lg-6">
                       <div class="form-group">
                       <label for="situacion_militar_definida" class="col-md-5 control-label">Situación Militar Definida:<span class='text-danger sm-text-label'>*</span> </label>
                        <div class="col-md-7">
                  ...
                  $("#guardar_datos_basicos_admin").prop('disabled',false);
                      ...
                      //  var nombres = $("#nombres").val();
                        $.each(data.responseJSON, function(index, val){
                         ...
                         $('#fr_datos_basicos input[name='+index+']').css({"border": "1px solid red"}).after('<span class="text-danger text">'+val+'</span>');
                         $('#fr_datos_basicos select[name='+index+']').css({"border": "1px solid red"}).after('<span class="text-danger text">'+val+'</span>');

                            if(index === "ciudad_residencia"){
                             $('#fr_datos_basicos input[name="txt_residencia"]').css({"border": "1px solid red"}).after('<span class="text-danger text">'+val+'</span>');
                            }

                            if(index === "ciudad_nacimiento"){
                             $('#fr_datos_basicos input[name="txt_nacimiento"]').css({"border": "1px solid red"}).after('<span class="text-danger text">'+val+'</span>');
                            }
                            
                            if(index === "ciudad_expedicion_id"){
                             $('#fr_datos_basicos input[name="ciudad_autocomplete"]').css({"border": "1px solid red"}).after('<span class="text-danger text">'+val+'</span>');
                            }
                 ...
                 <h3 class="header-section-form">
                  {{(route('home') == "https://gpc.t3rsc.co")?'Formacion Academica':'Mis Estudios'}} <span class='text-danger sm-text'> Campos con asterisco(*) son obligatorios</span> </h3>
                    ...
                    <div class="col-sm-6 col-lg-6">
                      ...
                      <div class="form-group">
                        <label for="tipo_id" class="col-md-5 control-label">Estudio Actual? <span class='text-danger sm-text-label'>*</span> </label>
                            
                        <div class="col-md-7">
                         {!!Form::select("estudio_actual",[''=>"Seleccione", '1' => "Si", '2' => "No"], null, ["class" => "form-control empleo_actual", "id" => "estudio_actual"])!!}
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-6">
                     ...
                     <div class="col-sm-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <label class="col-md-5 control-label"> @if(route('home') == "https://gpc.t3rs.co") Ciudad estudio @else Ciudad  @endif @if(route('home') == "http://colpatria.t3rs.co" || route('home') == "https://colpatria.t3rs.co") /City Study @endif :  <span class='text-danger sm-text-label'>*</span> </label>    
                    ...
                    <div class="col-sm-6 col-lg-6 fecha_finalizacion_es">
                        <div class="form-group">
                            <label for="fecha_finalizacion" class="col-md-5 control-label">Fecha Inicio:  <span class='text-danger sm-text-label'>*</span> </label>
                            
                            <div class="col-md-7">
                               {!! Form::text("fecha_inicio",null,["class"=>"form-control","placeholder"=>"Fecha Inicio","id"=>"fecha_inicio_es"]) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                             ...
                             @if(route('home') != "https://gpc.t3rs.co")
                               {!! Form::text("fecha_finalizacion_es",null,["class"=>"form-control","placeholder"=>"Fecha Finalización","id"=>"fecha_finalizacion_es" ]) !!}


                             @else
                               {!! Form::date("fecha_finalizacion_es",null,["max"=>date('Y-m-d'),"class"=>"form-control","placeholder"=>"Fecha Finalización","id"=>"fecha_finalizacion_es" ]) !!} 
                             @endif
                            </div>
                        </div>
                    </div>
...
<script>
    $(function () {
        ...
        //Formato fecha
        $("#fecha_inicio_es, #fecha_finalizacion_es").datepicker(confDatepicker);

        //$("#fecha_finalizacion").datepicker(confDatepicker);

         $('.fecha_finalizacion_es').show();
            
           $('#estudio_actual').change(function(){
             if($(this).val() == 1){
               $('.fecha_finalizacion_es').hide();
             }else{
               $('.fecha_finalizacion_es').show();
             }
         });
                  ...
                  $("#guardar_estudios").prop('disabled',false);
                    if (response.success) {
                        ...
                        @endif
                            ...
                            tr.append($("<td></td>", {text: ((campos.estudio_actual == 1) ? "ESTUDIO ACTUAL" : campos.fecha_finalizacion)}));
                        @if(route('home') == "https://gpc.t3rs.co")
                           ...
                           @endif
                            ...
                            $("#fecha_finalizacion_es").val('');
                            $("#ciudad_autocomplete_estu").val('');
            ...
            id = objButton.parent().find("input").val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#fecha_inicio_es").val(response.data.fecha_inicio);
                        if(response.data.estudio_actual === '1'){}else{
                         $("#fecha_finalizacion_es").val(response.data.fecha_finalizacion);
                        }
                       ...
                       $("#ciudad_autocomplete_estu").val(response.ciudad_estudios);
        ...
        $(document).on("click","#actualizar_estudios", function() {
                       ...
                       //Busca todos los input y lo pone a su color original
                            $(document).ready(function(){
                              ...
                              $("select").css({"border": "1px solid #ccc"});
                                ...
                                //Cambiar color del borde a color rojo
                                 document.getElementById(key).style.border = 'solid red';
                                //para ciudad obligatoria
                                if(key === 'ciudad_estudio'){
                                  document.getElementById('ciudad_autocomplete_estu').style.border = 'solid red';
                                }
                                //ciudad estudio obligatoria
                                });
                        }
                      mensaje_danger(response.mensaje_success);
                      $("#fecha_finalizacion_es").val('');
           ...
           // $('.editar_estudio_p')prop('disabled',false);
           $(".disabled_estudio").prop("disabled", false);
        });
        ...
        {!! Form::hidden("id",null,["class"=>"id_modificar_experiencia", "id"=>"id_modificar_experiencia"]) !!}
            ...
            <div class="row">
              ...
              @if(route('home') != "https://gpc.t3rsc.co")
                <div class="col-sm-6 col-lg-6">
                  <div class="form-group">
                   <label for="numero_id" class="col-md-5 control-label"> Teléfono Empresa: <span></span></label>
                    <div class="col-md-7">
                     {!! Form::text("telefono_temporal",null,["maxlength"=>"10","class"=>"form-control", "id"=>"telefono_temporal", "placeholder"=>"Teléfono empresa"]) !!}
                    </div>
                    <p></p>
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                  <div class="form-group">
                   <label for="telefono_movil_jefe" class="col-md-5 control-label">Teléfono Móvil Jefe:<span class='text-danger sm-text-label'></span> </label>
                    <div class="col-md-7">
                     {!! Form::number("movil_jefe",null,["maxlength"=>"10","class"=>"form-control solo-numero", "placeholder"=>"Movil Jefe Inmediato","id"=>"telefono_movil_jefe"]) !!}
                     <p></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                  <div class="form-group">
                   <label for="telefono_jefe" class="col-md-5 control-label">Teléfono Fijo Jefe:<span class='text-danger sm-text-label'></span> </label>
                    ...
                    <div class="col-md-4">
                     {!! Form::number("fijo_jefe",null,["maxlength"=>"10","class"=>"form-control solo-numero", "id"=>"telefono_jefe", "placeholder"=>"Teléfono Jefe Inmediato"]) !!}
                    </div>
                    <div class="col-md-3">
                      {!! Form::number("ext_jefe",null,["class"=>"form-control solo-numero", "id"=>"ext_jefe", "placeholder"=>"Extension Fijo"]) !!}
                    </div>
                   <p></p>
                  </div>
                </div>
                ...
                <div id="funciones" class="col-sm-6 col-lg-12">
                  <div class="form-group">
                   <label for="funciones_logros" class="col-md-3 control-label">Funciones y Logros: <span class='text-danger sm-text-label'>*</span></label>
                    <div class="col-md-9">
                     {!!Form::textarea("funciones_logros",null,["class"=>"form-control", "rows"=>"3", "id"=>"funciones_logros"]) !!}
                    </div>
                ...
                <div class="grid-container table-responsive">
                    <table class="table table-striped" id="tbl_experiencias">
                        <thead>
                          <tr>
                           <th>Empresa</th>
                           <th>Cargo @if(route('home') == "https://gpc.t3rs.co") Supervisor @endif </th>
                          @if(route('home') != "https://gpc.t3rs.co")
                           <th>Teléfono Empresa</th>
                          @endif
                            @if(route("home") != "http://tiempos.t3rs.co" && route("home") != "https://tiempos.t3rs.co")
                            <th>Nombres @if(route('home') != "https://gpc.t3rs.co") Jefe Inmediato @else Supervisor @endif </th>
                            ...
                            <tr id="tr_{{$experiencia->id}}">
                             ...
                             @endif
                              ...
                              @endif
                                ...
                                <td>{{($experiencia->empleo_actual == 1)?'Empleo actual':$experiencia->fecha_final}}</td>
                                <td>
    ...
    @endif
     ...
     $(document).on('input', "[maxlength]", function (e) {
         ...
         //solo funciona con tipo number input
           var esto = $(this);
           esto.siblings('span').remove();
           var maxlength = $(this).attr('maxlength');
           var maxlengthint = parseInt(maxlength);
           var span = $('<span></span>').insertAfter(esto);
           span.css("color", "red");
            //console.log(esto);
             // esto.find('p').html('');
                   ...
                   if(response.success){
                    if ( response.tiene_experiencia ) {
                       ...
                       $(document).ready(function(){
                        ...
                        tr.append($("<td></td>", {text: campos.cargo_especifico}));
                      @if(route('home') != "https://gpc.t3rs.co")
                      ...
                      mensaje_danger(response.mensaje_success);
                        ...
                        $.each(response.errors,function(key,value){
                         //Cambiar color del borde a color rojo
                          document.getElementById(key).style.border = 'solid red';
                         if(key === 'ciudad_id'){
                           document.getElementById('autocompletado_residencia').style.border = 'solid red';
                         }
                        });
        ...
        $(document).on("click",".editar_experiencia", function() {
            ...
            id = objButton.parent().find("input").val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                      console.log(response.data.nivel_cargo);
                      $("#empleo_actual").val(response.data.empleo_actual);
                      ...
                      $("#nivel_cargo").val(response.data.nivel_cargo);
                    ...
                    @endif
                       ...
                       if(response.data.empleo_actual === "2"){
                        $('#actual_show').hide();
                        $('#motivo_r').show();
                       }
                        ...
                        $("#nivel_cargo").val(response.nivel_cargo);
                    }
                });
            }else{
                mensaje_danger("No se borro el registro, favor intentar nuevamente.");
                      ...
                      if(response.success) {
                        ...
                        $(".disabled_experiencia").prop("disabled", false);
                         ...
                         mensaje_success("Registro actualizado.");
                            ...
                            tr.eq(1).html(campos.cargo_especifico);
                            tr.eq(2).html(campos.telefono_temporal);
                            @if(route("home") != "http://tiempos.t3rs.co" && route("home") != "https://tiempos.t3rs.co")
                            tr.eq(3).html(campos.nombres_jefe);
                            tr.eq(4).html(campos.movil_jefe);
                            //tr.eq(4).html(campos.fijo_jefe);

                           @endif
                            tr.eq(5).html(campos.fecha_inicio);
                            if (campos.empleo_actual == 1) {
                              tr.eq(6).html('Empleo actual');
                            }else{
                              tr.eq(6).html(campos.fecha_final);
                            }
                    ...
                    <table class="table table-striped" id="table_referencias">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;"> Teléfono Móvil</th>
                        ...
                        <tbody>
                          ...
                          @endif
                            ...
                            <tr id="tr_{{$referencia->id}}">
                              <td style="text-align:center;">{{$referencia->nombres}}</td>
                              <td style="text-align:center;">{{ $referencia->primer_apellido." ".$referencia->segundo_apellido }}</td>
                              <td style="text-align:center;">{{$referencia->telefono_movil}}</td>
                              <td style="text-align:center;">{{$referencia->ocupacion}}</td>
                              <td style="text-align:center;">{{$referencia->relacion}}</td>
                              <td style="text-align:center;">{{$referencia->ciudad_seleccionada}}</td>
                              <td>
                                {!! Form::hidden("id",$referencia->id, ["id"=>$referencia->id]) !!}
                                 <button type="button" class="btn btn-primary btn-peq editar_referencia disabled_referencia"><i class="fa fa-pencil"></i>&nbsp;Editar</button>
                    ...
                    //Busca todos los input y lo pone a su color original
                     $(document).ready(function(){
                      ...
                      var fila = $("<tr id='tr_" + data.id + "' ></tr>");
                        ...
                        fila.append($("<td></td>", {text: data.ocupacion}));
                        ...
                        if (response.error){
                            //Busca todos los input y lo pone a su color original
                          $(document).ready(function(){
                            $("#fr_datos_referencia input").css({"border": "1px solid #ccc"});
                            $("#fr_datos_referencia select").css({"border": "1px solid #ccc"});
                          });

                            //Recorrer el errors y cambiar de color a los input reqeuridos
                            $.each(response.error,function(key,value){
                              //console.log($("#fr_datos_referencia #"+key).parents().html());
                             //Cambiar color del borde a color rojo
                             $("#fr_datos_referencia input[name='"+key+"']").css({"border": "1px solid red"});
                             $("#fr_datos_referencia select[name='"+key+"']").css({"border": "1px solid red"});
                             //document.getElementById(key).style.border = 'solid red';
                            });
                        }
...
<div class="col-right-item-container">
    <div class="container-fluid">
        <div id="grupo_container">
            ...
            <div class="col-md-12 separador"></div>
            <p class="direction-botones-center set-margin-top">
              <button class="btn btn-warning pull-right" type="button" id="cancelar_familiar" style="display:none; margin: auto 10px auto;"><i class="fa fa-pencil"></i>&nbsp;Cancelar</button>
                ...
                <div class="grid-container table-responsive">
                    <table class="table table-striped" id="tbl_familia">
                        <thead>
                            ...
                            @if(route('home')!= "http://tiempos.t3rs.co" && route('home')!= "https://tiempos.t3rs.co" && route('home')!= "https://gpc.t3rs.co")
                        ...
                        <tbody>
                         @if($familiares->count() == 0)
                            ...
                            <tr id="tr_{{$familiar->id}}">
                             ...
                             @if(route('home')!= "http://tiempos.t3rs.co" && route('home')!= "https://tiempos.t3rs.co" && route('home')!= "https://gpc.t3rs.co")
                              <td> @if ($familiar->fecha_nacimiento != "" && $familiar->fecha_nacimiento != "0000-00-00") {{$familiar->fecha_nacimiento}} @endif</td>
                      ...
                      if(response.errors){
                          ...
                          mensaje_danger(response.mensaje_success);
                            ...
                            $.each(response.errors,function(key,value){
                               console.log(key);
                                //Cambiar color del borde a color rojo
                              if(key === 'nombres'){ document.getElementById('nombres_familiar').style.border = 'solid red';
                              }
                               if(key === 'primer_apellido'){ 
                                document.getElementById('primer_apellido_familiar').style.border = 'solid red';
                               }
                               if(key === 'escolaridad_id'){ 
                                document.getElementById('escolaridad_id_familiar').style.border = 'solid red';
                               }
                                
                                if(key === 'profesion_id'){ 
                                 document.getElementById('profesion_id').style.border = 'solid red';
                                }

                                if(key === 'parentesco_id'){ 
                                 document.getElementById('parentesco_id_familiar').style.border = 'solid red';
                                }

                                if(key === 'genero'){ 
                                 document.getElementById('genero_familiar').style.border = 'solid red';
                                }
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        tr.eq(0).html(campos.parentesco);
...
<script>
    $(function () {
        ...
        /* mensaje de succes al cargar datos de aprendiz*/
        @if(Session::has("mensaje_success"))
        console.log("entro aqui pero no sirve el mensaje succes")
...
<div class="col-right-item-container">
    <div class="container-fluid">
        <h3 class="header-section-form">Datos de Aprendiz</h3>
        <div id="container_referencia">
          {!! Form::model($datos_aprendiz,["class"=>"form-horizontal form-datos-basicos" ,"role"=>"form","id"=>"fr_datos_aprendiz", "route" => "admin.guardar_datos_aprendiz", "method" => "POST"]) !!}
          {!! Form::hidden("datos_basicos_id",$datos_basicos->id) !!}
            <div class="row">

                <div class="col-sm-6 col-lg-6">
                 <div class="form-group">
                  <label for="ref_nombres" class="col-md-5 control-label">Especialidad o Curso:</label>
                   <div class="col-md-7">
                    {!! Form::text("especialidad",null,["class"=>"form-control", "placeholder"=>"Especialidad", "id"=> "especialidad"]) !!}
                    </div>
                 </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                  <div class="form-group">
                   <label for="ref_apellido1" class="col-md-5 control-label">No. Grupo</label>
                     <div class="col-md-7">
                      {!! Form::text("numero_grupo",null,["class"=>"form-control", "placeholder"=>"Numero de Grupo", "id"=>"numero_grupo"]) !!}
                      </div>
                  </div>
                </div>
               ...
               <div class="col-sm-6 col-lg-6">
                <div class="form-group">
                 <label for="empresa" class="col-md-5 control-label">Institución de formación: </label>
                  <div class="col-md-7">
                   {!! Form::text("institucion",null,["class"=>"form-control", "placeholder"=>"institución", "id"=>"institucion"]) !!}
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="form-group">
                      <label for="ref_apellido2" class="col-md-5 control-label">Si es SENA centro de formación</label>
                        <div class="col-md-7">
                         {!! Form::text("sena_centro_formacion",null,["class"=>"form-control", "placeholder"=>"centro de formación", "id" => "sena_centro_formacion"]) !!}
                        </div>
                    </div>
                </div>
            ...
            <p class="direction-botones-center set-margin-top">
                ...
                <button class="btn btn-success pull-right" type="submit" id="guardar_datos_aprendiz" ><i class="fa fa-floppy-o"></i>&nbsp;Guardar</button>
            </p>
            {!!  Form::close() !!}<!-- /.fin form -->
        </div>
    </div>
