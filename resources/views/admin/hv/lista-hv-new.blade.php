                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div class="btn-group-vertical">
                                                ...
                                                @if($lista->id_valores_general != null || $lista->id_competencias_sola || $lista->id_excel_basico != null || $lista->id_excel_intermedio != null)
                                                    <div class="btn-group">
                                                        <button
                                                            type="button"
                                                        ...
                                                        <ul class="dropdown-menu pd-0">
                                                            <div class="btn-group-vertical" role="group" aria-label="..." style="width: 100%;">
                                                                ...
                                                                @if($lista->id_competencias_sola != null)
                                                                    <a
                                                                        href="{{ route('admin.prueba_competencias_informe_sola', ['id' => $lista->id_competencias_sola]) }}"
                                                                        target="_blank"
                                                                        class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none"
                                                                ...
                                                                @if($lista->id_excel_basico != null)
                                                                    <a
                                                                        class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none"
                                                                        target="_blank"
                                                                        href="{{ route('admin.pdf_prueba_excel_solo', ['id_respuesta_user' => $lista->id_excel_basico]) }}"
                                                                ...
                                                                @if($lista->id_excel_intermedio != null)
                                                                    <a
                                                                        class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none"
                                                                        target="_blank"
                                                                        href="{{ route('admin.pdf_prueba_excel_solo', ['id_respuesta_user' => $lista->id_excel_intermedio]) }}"
