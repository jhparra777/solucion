...
<body>
    ...
    <main class="main">
        ...
        @if($entrevistas_semi->count() > 0)
            <section class="secciones-titulos-2">
                <h2 style="color: #6F3795;" class="text-uppercase">ENTREVISTA SEMIESTRUCTURADA</h2>
                <hr align="left" class="divider-hd" style="margin-top: -.5rem;">
            </section>
            ...
            <section>
                <div class="m-auto" style="width: 95%;">
                    <p class="text-justify color-sec">
                        <a href="{{route('admin.informe_entrevista_semi_pdf',['req_can'=>$reqcandidato->requerimiento_cantidato_id])}}" target="_blank" class="enlace" >Ver Entrevista</a>
                    </p>
                </div>
            </section>
        @endif
