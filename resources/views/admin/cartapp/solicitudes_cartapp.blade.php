                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pd-0">
                                                    ...
                                                    <a
                                                        class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none"
                                                        target="_blank"
                                                        href="{{ route('admin.documentos_contratacion', ['candidato' => $lista->user_id, 'req' => $lista->requerimiento_id]) }}"
                                                    >
                                                        CARPETA CONTRATACIÓN
                                                    </a>

                                                    <a
                                                        class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none"
                                                        target="_blank"
                                                        href="{{ route('admin.documentos_post', ['candidato' => $lista->user_id, 'req' => $lista->requerimiento_id]) }}"
                                                        style="padding: .5rem 10px;" 
                                                    >
                                                        CARPETA POST CONTRATACIÓN
                                                    </a>
                                                </ul>
                                            </div>
                                        </div>
