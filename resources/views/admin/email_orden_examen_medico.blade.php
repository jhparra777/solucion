                    ...
                    <td>
                        @if(isset($candidato->empresa_contrata))
                            {{--@if($empresa != '' && $empresa->logo != null)
                                <img style="max-width: 200px float: right;" src="{{ url('configuracion_sitio')}}/{{ $empresa->logo }}">--}}
                            @if(isset(FuncionesGlobales::sitio()->logo))
                                @if(FuncionesGlobales::sitio()->logo != "")
                                    <img style="max-width: 200px; float: right;" src="{{ url('configuracion_sitio')}}/{!! ((FuncionesGlobales::sitio()->logo)) !!}">
                                @else
                                    <img style="max-width: 200px; float: right;" src="{{url('img/logo.png')}}" >
                                @endif
                            @else
                                <img style="max-width: 200px; float: right;" src="{{url('img/logo.png')}}">
                            @endif
