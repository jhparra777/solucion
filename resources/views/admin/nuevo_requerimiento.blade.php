...
@section("contenedor")
    ...
    <script>
        ...
        $(document).on('click', '#enviar_requerimiento_btn', function() {
            ...
            }else if($('#tipo_trabajo').val() == ''){
                
                $('#tipo_trabajo').css('border', 'solid 1px red');
                $('#tipo_trabajo').focus();

                setTimeout(function(){ 
                    $('#tipo_trabajo').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#sercon_id').val() == ''){
                
                $('#sercon_id').css('border', 'solid 1px red');
                $('#sercon_id').focus();

                setTimeout(function(){ 
                    $('#sercon_id').css('border', 'solid 1px #d2d6de');
                }, 4000);
            ...
            }else if($('#tipo_contrato_id').val() == 6 && $('#dias_semana_teletrabajo_id').val() == '' ){

                $('#dias_semana_teletrabajo_id').css('border', 'solid 1px red');
                $('#dias_semana_teletrabajo_id').focus();

                setTimeout(function(){
                    $('#dias_semana_teletrabajo_id').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#tipo_contrato_id').val() == 6 && $('#horario_teletrabajo_id').val() == '' ){

                $('#horario_teletrabajo_id').css('border', 'solid 1px red');
                $('#horario_teletrabajo_id').focus();

                setTimeout(function(){
                    $('#horario_teletrabajo_id').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#tipo_contrato_id').val() == 6 && $('#tipo_teletrabajador_id').val() == '' ){

                $('#tipo_teletrabajador_id').css('border', 'solid 1px red');
                $('#tipo_teletrabajador_id').focus();

                setTimeout(function(){
                    $('#tipo_teletrabajador_id').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#tipo_contrato_id').val() == 6 && $('#descanso_teletrabajador_id').val() == '' ){

                $('#descanso_teletrabajador_id').css('border', 'solid 1px red');
                $('#descanso_teletrabajador_id').focus();

                setTimeout(function(){
                    $('#descanso_teletrabajador_id').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#tipo_contrato_id').val() == 6 && $('#dias_teletrabajo_id').val() == '' ){

                $('#dias_teletrabajo_id').css('border', 'solid 1px red');
                $('#dias_teletrabajo_id').focus();

                setTimeout(function(){
                    $('#dias_teletrabajo_id').css('border', 'solid 1px #d2d6de');
                }, 4000);

            }else if($('#tipo_contrato_id').val() == 6 && $('#dias_trabajo_oficina_id').val() == '' ){

                $('#dias_trabajo_oficina_id').css('border', 'solid 1px red');
                $('#dias_trabajo_oficina_id').focus();

                setTimeout(function(){
                    $('#dias_trabajo_oficina_id').css('border', 'solid 1px #d2d6de');
                }, 4000);
