            ...
            <div class="row">
                ...
                @if(route("home")!="https://expertos.t3rsc.co" && route("home")!="https://gpc.t3rsc.co")
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <ul class="use-slt-link">
                            <li>
                                <a target="_blank" href="http://www.solucionesinmediatas.com.co/index.php/quienes-somos/2016-10-04-21-34-37">Tratamiento de datos personales SOLUCIONES INMEDIATAS</a></li>
                            <li id="inactivaBotonesModal"><a href="#" data-toggle="modal" data-target="#myModal">Tratamiento de datos personales T3RS</a></li>
