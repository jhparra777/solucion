...
Route::get('test', ["uses" => "TestCodeController@test"]);
...
Route::get("generar-pdf-sst/{req_cand_id}", ["as" => "generar_pdf_evaluacion_sst", "uses" => "EvaluacionSstController@generar_pdf_evaluacion_sst"]);
...
Route::get("pdf-prueba-excel-solo/{id_respuesta_user}", ["as" => "pdf_prueba_excel_solo", "uses" => "PruebaExcelSoloController@pdf_prueba_excel_candidato"]);
...
Route::post("envaluacion_sst", ["as" => "evaluacion_sst", "uses" => "ReclutamientoController@evaluacion_sst"]);

Route::post("guardar_cambio_estado", ["as" => "guardar_cambio_estado", "uses" => "ReclutamientoController@guardar_cambio_estado"]);

Route::post("confirmar_envaluacion_sst", ["as" => "confirmar_evaluacion_sst", "uses" => "ReclutamientoController@confirmar_evaluacion_sst"]);

Route::get("lista_envaluacion_sst", ["as" => "lista_evaluacion_sst", "uses" => "ReclutamientoController@lista_sst"]);

Route::get("gestionar_envaluacion_sst/{candidato}", ["as" => "gestionar_evaluacion_sst", "uses" => "ReclutamientoController@gestionar_evaluacion_sst"]);

Route::get("realizar_envaluacion_sst/", ["as" => "realizar_evaluacion_sst", "uses" => "ReclutamientoController@realizar_evaluacion_sst"]);

Route::get("realizar_envaluacion_sst/", ["as" => "admin.reportes_diario_seleccion", "uses" => "ReclutamientoController@realizar_evaluacion_sst"]);
Route::post("firma_envaluacion_sst", ["as" => "firma_evaluacion_sst", "uses" => "ReclutamientoController@guardar_firma_sst"]);
Route::post("realizar_envaluacion_sst/", ["as" => "realizar_evaluacion_sst", "uses" => "ReclutamientoController@realizar_evaluacion_sst"]);
Route::post("guardar_envaluacion_sst", ["as" => "guardar_evaluacion_sst", "uses" => "ReclutamientoController@guardar_evaluacion_sst"]);

Route::get("pdf_envaluacion_sst/{id}", ["as" => "pdf_evaluacion_sst_anterior", "uses" => "ReclutamientoController@pdf_evaluacion_sst"]);

Route::get("autocomplete_cuidades_all", ["as" => "autocomplete_cuidades_all", "uses" => "DatosBasicosController@autocomplete_cuidades_all"]);

//ruta para generar carnet candidato
Route::get("generar_carnet/{id}", ["as" => "generar_carnet", "uses" => "ReclutamientoController@generar_carnet"]);
...
Route::post('tipos-trabajos-por-tipo-contrato', ["as" => "tiposTrabajosPorTipoContrato", "uses" => "RequerimientoController@tiposTrabajosPorTipoContrato"]);
...
Route::group(['prefix' => 'cv'], function () {
    ...
    //Prueba brig - Rutas Sola
    Route::get('prueba-inicio-cv', ['as' => 'cv.prueba_inicio_sola', 'uses' => 'PruebaPerfilSolaController@index']);

    Route::get('prueba-bryg-cv', ['as' => 'cv.prueba_perfilamiento_sola', 'uses' => 'PruebaPerfilSolaController@start']);
    // Route::get('prueba-perfilamiento/siguiente', ['as' => 'cv.prueba_perfilamiento_siguiente', 'uses' => 'PruebaPerfilSolaController@set_content']);
    Route::post('prueba-bryg-guardar-cv', ['as' => 'cv.prueba_perfilamiento_guardar_sola', 'uses' => 'PruebaPerfilSolaController@save_result']);
    Route::post('prueba-bryg-guardar-fotos-cv', ['as' => 'cv.prueba_bryg_guardar_fotos_sola', 'uses' => 'PruebaPerfilSolaController@guardar_fotos']);
    Route::get("prueba-bryg-informe-cv/{bryg_id}", ["as" => "cv.prueba_bryg_informe_sola", "uses" => "PruebaPerfilSolaController@informe_prueba_bryg"]);

    Route::get("prueba-bryg-informe-preview/{bryg_id}/{req_id}/{user_id}", ["as" => "cv.prueba_bryg_informe_preview", "uses" => "PruebaPerfilSolaController@informe_prueba_bryg_preview"]);
    ...
    //Prueba Excel Basico Solo
    Route::get('prueba-excel-basico-solo', ['as' => 'cv.prueba_excel_solo_basico', 'uses' => 'PruebaExcelSoloController@index_basico']);

    Route::post('prueba-excel-solo-basico-save', ['as' => 'cv.prueba_excel_solo_basico_save', 'uses' => 'PruebaExcelSoloController@save_result_basico']);

    //Prueba Excel Intermedio Solo
    Route::get('prueba-excel-intermedio-solo', ['as' => 'cv.prueba_excel_solo_intermedio', 'uses' => 'PruebaExcelSoloController@index_intermedio']);

    Route::post('prueba-excel-solo-intermedio-save', ['as' => 'cv.prueba_excel_solo_intermedio_save', 'uses' => 'PruebaExcelSoloController@save_result_intermedio']);

    Route::get('resultados-prueba-excel-solo/{user_id}/{resp_user_id}', ['as' => 'cv.ver_resultados_prueba_excel_solo', 'uses' => 'PruebaExcelSoloController@verResultados']);
    //Fin rutas Excel
    ...
    //Prueba de Valores 1 General
    Route::get('prueba-ethical-values-general', ['as' => 'cv.prueba_valores_general', 'uses' => 'PruebaEthicalValuesController@index_prueba']);

    Route::post('prueba-valores-general-save', ['as' => 'cv.prueba_valores_general_save', 'uses' => 'PruebaEthicalValuesController@save_result_valores']);
    ...
    */
    ...
    Route::get('competencias-inicio-cv', ['as' => 'cv.competencias_inicio_sola', 'uses' => 'PruebaCompetenciasSolaController@index']);
    Route::get('prueba-competencias-cv', ['as' => 'cv.prueba_competencias_sola', 'uses' => 'PruebaCompetenciasSolaController@start']);

    Route::post('prueba-competencias-guardar-cv', ['as' => 'cv.prueba_competencias_guardar_sola', 'uses' => 'PruebaCompetenciasSolaController@store']);

    Route::post('prueba-competencias-guardar-fotos-cv', ['as' => 'cv.prueba_competencias_guardar_fotos_sola', 'uses' => 'PruebaCompetenciasSolaController@guardar_fotos']);

    Route::get("prueba-competencias-informe-cv/{prueba_id}", ["as" => "admin.prueba_competencias_informe_sola", "uses" => "PruebaCompetenciasSolaController@informe_prueba_competencias"]);

    Route::get("prueba-competencias-informe-preview/{prueba_id}/{req_id}/{user_id}", ["as" => "admin.prueba_competencias_informe_preview", "uses" => "PruebaCompetenciasSolaController@informe_prueba_competencias_preview"]);
    ...
    Route::group(['middleware' => ['valida_cv', "sesion_datos_basicos", "valida_datos_basicos"]], function () {
        ...
        // Pruebas
        Route::get("mis-pruebas", ["as" => "cv.pruebas_psicotecnicas", "uses" => "PruebasCvController@index"]);
    });
...
Route::group(['prefix' => 'req'], function () {
    ...
    //Contratados
        ...
        Route::get("documentos_confidenciales/{candidato}/{req}", ["as" => "req.documentos_confidenciales", "uses" => "ClienteContratadosController@documentos_confidenciales"]);
        Route::get("documentos_post/{candidato}/{req}", ["as" => "req.documentos_post", "uses" => "ClienteContratadosController@documentos_post"]);
...
Route::group(['prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::get('salud_ocupacional', ['as' => 'admin.salud_ocupacional', 'uses' => 'ContratacionController@salud_ocupacional']);
    ...
    Route::group(['middleware' => ['valida_admin', 'sesion_admin']], function () {
        ...
        Route::get("indicadores-oportunidad", [
         ...
         Route::get("indicadores-examenes-medicos", [
            "as"   => "admin.indicador.indicadores_examenes_medicos",
            "uses" => "IndicadorController@indicador_examenes_medicos",
        ]);
        ...
        //Reporte Registro Aceptacion Excel
        Route::get("reportes-registro-aceptacion-ley-1581-excel", [
            'as'   => 'admin.reportes_registro_aceptacion_excel',
            'uses' => 'ReportesController@reportesRegistroAceptacionExcel',
        ]);
        ...
        Route::get("reportes-registro-aceptacion-ley-1581", [
            'as'   => 'admin.reporte_registro_aceptacion',
            'uses' => 'ReportesController@reportesRegistroAceptacion',
        ]);
        ...
        //Evaluacion SST Masivo
        Route::post("enviar_sst_masivo", ["as" => "admin.enviar_sst_masivo", "uses" => "ReclutamientoController@enviar_sst_masivo"]);
        Route::post("confirmar_sst_masivo", ["as" => "admin.confirmar_sst_masivo", "uses" => "ReclutamientoController@guardar_sst_masivo"]);
        //Fin Evaluacion SST Masivo
        ...
        Route::post("registra_entrevista_entidad_semi", ["as" => "admin.registra_entrevista_entidad_semi", "uses" => "EntrevistaSemiController@registra_proceso_entidad"]);
        ...
        Route::post("registra_entrevista_entidad2", ["as" => "admin.registra_entrevista_entidad2", "uses" => "EntrevistaController@registra_proceso_entidad2"]);
         ...
         Route::post("registra_entrevista_entidad2_semi", ["as" => "admin.registra_entrevista_entidad2_semi", "uses" => "EntrevistaSemiController@registra_proceso_entidad2"]);
        ...
        //cargar datos aprendiz

        Route::post("guardar-datos-aprendiz", ["as" => "admin.guardar_datos_aprendiz", "uses" => "DatosAprendizController@store"]);
        ...
        Route::post("cambiar_concepto_medico", ["as" => "admin.cambiar_concepto_medico", "uses" => "DocumentosController@cambiar_concepto_medico"]);
        Route::post("confirmar_cambiar_concepto_medico", ["as" => "admin.confirmar_cambiar_concepto_medico", "uses" => "DocumentosController@confirmar_cambiar_concepto_medico"]);
        ...
        */
         ...
         * Reusar pruebas
         */
        Route::post("gestion-reusar-pruebas", ["as" => "admin.gestion.reusar_pruebas", "uses" => "ReusarPruebasController@confirmar_reusar"]);
        ...
        */
        ...
        Route::post("detalle_rodamiento_view", ["as" => "admin.rodamiento_view", "uses" => "ReclutamientoController@rodamiento_view"]);

        Route::post("confirmar_rodamiento", ["as" => "admin.confirmar_rodamiento", "uses" => "ReclutamientoController@confirmar_rodamiento"]);
        ...
        Route::get("entrevista-semiestructurada/{req_can}", ["as" => "admin.informe_entrevista_semi_pdf", "uses" => "EntrevistaSemiController@generar_pdf"]);
        //-----
        ...
        Route::get("gestionar_documentos_medicos/{ref_id}/{edit?}", ["as" => "admin.gestionar_documentos_medicos", "uses" => "DocumentosController@gestionar_documentos_medicos"]);
        ...
        //Rutas SERCON
        Route::group(['prefix' => 'sercon'], function(){
            
            Route::get("lista", ["as" => "admin.sercon.index", "uses" => "SerconController@index"]);
            Route::get("editar/{id}", ["as" => "admin.sercon.editar", "uses" => "SerconController@editar"]);
            Route::get("nuevo", ["as" => "admin.sercon.nuevo", "uses" => "SerconController@nuevo"]);
            Route::post("actualizar", ["as" => "admin.sercon.actualizar", "uses" => "SerconController@actualizar"]);
            Route::post("guardar", ["as" => "admin.sercon.guardar", "uses" => "SerconController@guardar"]);
            Route::get("cambiar-estado/{id}", ["as" => "admin.sercon.cambiar_estado", "uses" => "SerconController@cambiarEstado"]);
        });
    ...
    Route::get("preliminar-prueba-ethical-values/{tipo}/{respuesta_id}/{req_id}", ["as" => "admin.preliminar_prueba_valores", "uses" => "PruebaValoresController@preliminar_reusable_prueba_valores"]);

    Route::get("pdf-ethical-values-general/{id_respuesta_user}", ["as" => "admin.pdf_prueba_valores_general", "uses" => "PruebaEthicalValuesController@pdf_prueba_valores_general"]);
    ...
    Route::get("pdf-prueba-excel/{id_respuesta_user}", ["as" => "admin.pdf_prueba_excel_solo", "uses" => "PruebaExcelSoloController@pdf_prueba_excel"]);
